...
export default function Location() {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-start mt-[4rem]">
      {/* Tipos de torra */}
      ...
      <Image
        src="/umgrao.png"
        alt="colhercomcafe"
        className=" hidden lg:block left-1"
        height={200}
        width={200}
        quality={100}
        priority
      ...
      >
        ...
        <div className="flex flex-col text-lg gap-4 mt-2">
          ...
          <div className="flex flex-col font-inria gap-2 text-lg">
            ...
            <span>- Sábado e Domingo: 09:00 AM - 17:00 PM</span>
          </div>
        </div>
      </div>
    </div>
